...
1) in terminal run: ./main -a offshore_petsc -b offshore_b_petsc -ksp_monitor ascii:convergence.txt  
Explanation:	-a offshore_petsc takes the file offshore_petsc as the matrix A
		...
		-ksp_monitor without specifying the .txt file prints the relative residual norms to the console
